...
[![DOI](https://zenodo.org/badge/17012304.svg)](https://zenodo.org/badge/latestdoi/17012304)
...
All unedited manuscript figures and data can be generated by executing the commands in main_2022_outbreak.ipynb (Fig 1 - Fig 4) and main_future_outbreak.ipynb (Fig 5). To reproduce the population sampling, the complete file `MPox_final_merged_19062024.csv` has to be obtained from [here](https://bmcinfectdis.biomedcentral.com/articles/10.1186/s12879-024-10066-z).
