...
cdef class World:
    def __init__(self, double inf_rate, double diag_rate, double incubation_rate, double recovery_rate, int number_infectious_compartments, double return_vacc, double return_unvacc, int i0, long[::1] mu_vec, double[::1] mu_1, double[::1] lambda_plus_vec, double[::1] lambda_minus_vec, long[::1] behaviour_strong, long[::1] behaviour_somewhat, double behaviour_change, double behaviour_change_rate, double[::1] inf_rate_vec, double[::1] bc_vec, double warm_up, int t_max):
        self.network = Network(mu_vec, mu_1, lambda_plus_vec, lambda_minus_vec, behaviour_strong, behaviour_somewhat, inf_rate_vec, bc_vec, warm_up)
